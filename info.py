...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002656879612'))  # Notification of those who verify will be sent to your channel
...
if HAS_SSL:
    URL = "https://conservative-michaela-kannadaflixmoviez-a8fafbb9.koyeb.app/".format(FQDN)
else:
    URL = "https://conservative-michaela-kannadaflixmoviez-a8fafbb9.koyeb.app/".format(FQDN)
